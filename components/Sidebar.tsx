    ...
    <>
        ...
        {mobileOpen && (
            <div className="fixed inset-0 z-40 lg:hidden" role="dialog" aria-modal="true" aria-label="Mobile navigation">
                ...
                <aside className="sidebar-surface absolute bottom-0 left-0 top-16 w-[min(20rem,calc(100vw-2rem))] border-r sidebar-border shadow-[20px_0_50px_rgba(0,0,0,0.2)] sm:top-20">
